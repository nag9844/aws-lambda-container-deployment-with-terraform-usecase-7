...
output "docker_login_command" {
  ...
  value       = "aws ecr get-login-password --region ${var.aws_region} | docker login --username AWS --password-stdin ${aws_ecr_repository.main.repository_uri}"
}
...
output "docker_build_commands" {
  ...
  value = [
    ...
    "docker tag ${aws_ecr_repository.main.name}:latest ${aws_ecr_repository.main.repository_uri}:latest",
    "docker push ${aws_ecr_repository.main.repository_uri}:latest"
  ]
}