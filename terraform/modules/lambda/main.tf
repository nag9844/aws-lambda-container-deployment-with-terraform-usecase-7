...
resource "aws_lambda_function" "main" {
  ...
  filename         = var.force_container_mode ? null : "${path.module}/placeholder.zip"
  source_code_hash = var.force_container_mode ? null : filebase64sha256("${path.module}/placeholder.zip")
